...
def duplicate_labels(images_list,path1,path2):
  ...
  for x in images_list:
    ...
    image_label_f = os.path.join(path2, f'{img_without_extention.stem}'+'_c.txt')
...
def duplicate_images(images_list,path1,path2):
  ...
  for x in images_list:
    img_without_extention = Path(x)
    image = os.path.join(path1, f'{img_without_extention.stem}.png')
    image_f = os.path.join(path2, f'{img_without_extention.stem}'+'_c.jpg')
